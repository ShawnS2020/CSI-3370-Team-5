...
const workout5 = new Workout("Chin-ups", "Chin to the bar. Reverse grip", ["Upper back", "biceps", "rear delts", "core"]);
const workout6 = new Workout("Pull-ups", "Chin to the bar. Forward grip", ["Upper back", "biceps", "rear delts", "core"]);
const workout7 = new Workout("Deadlifts", "Pick up dat bar", ["Upper back", "lower back", "glutes", "hamstrings", "core"]);
const workout8 = new Workout("Lat pulldowns", "Pulldown dat bar", ["Upper back", "biceps", "rear delts", "core"]);
const workout9 = new Workout("Rows", "Row however you row", ["Upper back", "lower back", "biceps", "rear delts", "core"]);
const workout10 = new Workout("Squats", "Squat dat bar", ["Glutes", "quads", "core"]);
